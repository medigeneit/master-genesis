...
namespace Medigeneit\MasterGenesis\Facades;
 ...
 *
 * @see Medigeneit\MasterGenesis\BookingHttpFactory
 */
class BookingHttp extends Facade
{

    public static function getFacadeAccessor()
    {
        return BookingHttpFactory::class;
    }
}
